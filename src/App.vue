<template>
  ...
  <div class="p-4">
    <div class="experience flex justify-center flex-col items-center space-y-3">
      ...
      <h1
        data-aos="fade-up"
        class="text-2xl md:text-4xl bg-clip-text bg-gradient-to-r from-lime-500 via-blue-600 to-yellow-500 text-transparent pt-4"
      >
        Backend
      </h1>
      ...
      >
        <div class="cursor-pointer transition hover:-translate-y-2 w-14 justify-self-center self py-px flex items-center justify-center">
          <img
      ...
      <h1
        data-aos="fade-up"
        class="text-2xl md:text-4xl bg-clip-text bg-gradient-to-r from-violet-500 via-pink-600 to-yellow-500 text-transparent pt-4"
      >
        Database
      </h1>
